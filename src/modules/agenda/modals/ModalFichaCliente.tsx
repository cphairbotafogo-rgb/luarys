...
export function ModalFichaCliente({ clienteId, perfil, onClose, onSalvo, abaInicial }: Props) {
  ...
  const { formCliente, set, setAnamnese, toggleEtiqueta, etiquetasDb, carregando, salvando, buscarCep } = fc;
        ...
        <div style={{ overflowY: 'auto', flex: 1, padding: '24px 28px' }}>
          {carregando ? (
            ...
            <>
              ...
              {abaAtiva === 'endereco'     && <AbaEndereco formCliente={formCliente} set={set} buscarCep={buscarCep} buscandoCep={false} />}
